...
const metrics = [
  { 
    ...
    suffix: "/7", 
    prefix: "",
    label: "Leads captured (demo)",
    sublabel: "automated visitor pipeline",
  },
  { 
    value: 98, 
    suffix: "%", 
    prefix: "",
    label: "Qualification score (demo)",
    sublabel: "AI lead scoring model",
  },
  { 
    value: 100, 
    suffix: "%", 
    prefix: "",
    label: "Automated follow-up (demo)",
    sublabel: "instant response sequence",
  },
];
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
              ...
              Real-time
              <br />
              <span className="text-muted-foreground">lead metrics (demo).</span>
            </h2>
          </div>
        </div>
